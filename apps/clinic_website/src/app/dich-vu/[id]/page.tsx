        ...
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-primary hover:bg-primary/90 text-white font-bold text-[14px] px-6 py-3.5 transition-colors"
            >
              Hướng dẫn đặt lịch
