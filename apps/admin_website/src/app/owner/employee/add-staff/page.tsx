    ...
    <div className="animate-fade-in flex min-h-screen bg-slate-50 font-sans text-slate-800">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <OwnerPageHeader
          ...
          subtitle="Lưu hồ sơ nhân viên. Tài khoản đăng nhập có thể tạo sau."
        />
          ...
          <div className="w-full max-w-5xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 w-full">
              ...
              <div className="flex items-center justify-between border-b border-slate-200 pb-4 mb-2 shrink-0">
                <div>
                  <h3 className="text-lg font-extrabold text-slate-900 tracking-tight">Thêm mới hồ sơ Nhân viên</h3>
              ...
              <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-6">
                <div className="flex items-center justify-between mb-6 pb-2 border-b border-slate-100">
                  ...
                  <div className="text-[12px] font-bold text-slate-500">
                    Mã nhân viên: <span className="bg-red-50 border border-red-100 text-primary px-2.5 py-1 rounded font-mono font-extrabold">{isLoadingCode ? "Đang tạo..." : staffCode}</span>
                  </div>
                </div>
