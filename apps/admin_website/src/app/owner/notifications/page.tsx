...
const ALL_NOTIFICATIONS = [
  { id: 1, type: "appointment", title: "Lịch khám hôm nay",           body: "Có 12 bệnh nhân đã đặt lịch khám trong ngày hôm nay",                                              time: "5 phút trước",  date: "13/06/2026", read: false },
  { id: 2, type: "reminder",    title: "Đơn xin nghỉ chờ duyệt",      body: "Bác sĩ Trần Văn Minh xin nghỉ phép ngày 16/06 · Vui lòng phê duyệt",                              time: "30 phút trước", date: "13/06/2026", read: false },
  { id: 3, type: "system",      title: "Báo cáo doanh thu tháng 5",    body: "Báo cáo doanh thu tháng 5/2026 đã sẵn sàng · Doanh thu tăng 12% so với tháng trước",             time: "2 giờ trước",   date: "13/06/2026", read: false },
  { id: 4, type: "reminder",    title: "Hợp đồng sắp hết hạn",        body: "Hợp đồng nhà cung cấp vật tư y tế hết hạn vào 30/06/2026 · Cần gia hạn sớm",                     time: "3 giờ trước",   date: "13/06/2026", read: true  },
  { id: 5, type: "appointment", title: "Nhân viên mới onboard",        body: "Nhân viên Lê Thu Hà đã được thêm vào hệ thống · Role: Lễ tân",                                    time: "4 giờ trước",   date: "13/06/2026", read: true  },
  { id: 6, type: "system",      title: "Bảo trì hệ thống",            body: "Hệ thống sẽ bảo trì từ 22:00–23:00 tối nay · Vui lòng thông báo cho nhân viên",                   time: "Hôm qua",       date: "12/06/2026", read: true  },
  { id: 7, type: "reminder",    title: "Tồn kho vật tư thấp",         body: "5 mặt hàng dưới mức tối thiểu · Cần nhập thêm để đảm bảo hoạt động",                              time: "Hôm qua",       date: "12/06/2026", read: true  },
  { id: 8, type: "system",      title: "Đánh giá nhân viên định kỳ",  body: "Đã đến kỳ đánh giá hiệu suất Q2/2026 · Vui lòng hoàn thành trước ngày 20/06",                    time: "2 ngày trước",  date: "11/06/2026", read: true  },
];

const FILTERS = [
  { key: "all",         label: "Tất cả"   },
  { key: "unread",      label: "Chưa đọc" },
  { key: "appointment", label: "Hoạt động" },
...
const TYPE_LABEL: Record<string, string> = { appointment: "Hoạt động", reminder: "Nhắc nhở", system: "Hệ thống" };
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-20 bg-white/95 backdrop-blur-md border-b border-slate-200 px-8 h-16 flex items-center justify-between shrink-0 shadow-sm shadow-slate-100/50">
          <div>
            ...
            <p className="text-[12.5px] text-slate-400 font-semibold mt-0.5">Tất cả thông báo của bạn</p>
          </div>
        </header>
