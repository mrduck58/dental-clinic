      ...
      <div className="bg-white rounded-2xl border border-slate-200 w-full max-w-2xl shadow-2xl p-6 relative my-8 flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-[18px] font-black text-slate-900 leading-tight">Chỉnh Sửa Nhân Viên</h3>
              <p className="text-[13px] text-slate-400 font-semibold mt-0.5">Cập nhật hồ sơ và trạng thái nhân sự.</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Employee ID (BR-EMP-EDIT-002: Cannot be modified) */}
            <div>
              <label className={labelClass}>Mã nhân viên (Không thể sửa)</label>
              <input
                type="text"
                value={staff.employeeId || "Chưa thiết lập"}
                disabled
                className="w-full px-4 py-2.5 text-[13.5px] bg-slate-100 border border-slate-200 text-slate-400 rounded-xl font-semibold cursor-not-allowed"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="anhnv@dentalclinic.com"
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Phòng khám, Kế toán..."
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleChange}
                  className={inputClass("isActive") + " appearance-none pr-8 cursor-pointer"}
                >
                  <option value="true">Đang kích hoạt (Active)</option>
                  <option value="false">Tạm khóa (Locked/Inactive)</option>
                </select>
                <span className="absolute inset-y-0 right-3 flex items-center pointer-events-none text-slate-500">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={3}
              placeholder="Chuyên môn, bằng cấp..."
