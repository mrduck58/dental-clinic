    ...
    return (
      <div className="animate-fade-in flex min-h-screen bg-slate-50 font-sans text-slate-800">
        ...
        <main className="flex-1 flex flex-col items-center justify-center gap-4">
          ...
          <button onClick={() => router.push("/dashboard/employee")} className="px-6 py-3 bg-secondary text-white font-extrabold rounded-xl cursor-pointer">
            Quay lại danh sách
          </button>
        </main>
      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="flex items-center gap-2 px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl">
                      <span className="text-[14px] font-extrabold text-emerald-700">Bác sĩ</span>
                      <span className="text-[12px] text-slate-400 font-semibold">· Không thể thay đổi</span>
                    </div>
                  </div>
