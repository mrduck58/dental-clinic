...
const MOCK_NOTIFS: Notification[] = [
  ...
  { id: "N007", timestamp: "2026-06-12T13:00:00", type: "account",   priority: "medium", read: true,  title: "Đặt lại mật khẩu tài khoản",              body: "Tài khoản \"Lê Phương Thảo\" đã yêu cầu đặt lại mật khẩu. Link đặt lại đã được gửi và sử dụng thành công lúc 12:58." },
  ...
  { id: "N013", timestamp: "2026-06-11T14:10:00", type: "account",   priority: "high",   read: true,  title: "Phát hiện đăng nhập thất bại nhiều lần",  body: "Tài khoản \"doctor_thao\" bị thử đăng nhập sai mật khẩu 5 lần liên tiếp từ IP 182.23.41.12 lúc 14:05–14:09. Tài khoản đã tạm khóa 30 phút." },
