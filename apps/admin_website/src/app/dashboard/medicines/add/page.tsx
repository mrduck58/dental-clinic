...
export default function AddMedicinePage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Medicine data:", formDataToSend);
      setSaveSuccess(true);
      setTimeout(() => {
        window.location.href = "/dashboard/medicines";
      }, 1500);
    } catch {
      setSaveError("Thêm thuốc thất bại. Vui lòng thử lại.");
    } finally {
      setIsSaving(false);
    }
  };
        ...
        <div className="p-8 flex-1 overflow-y-auto">
          {saveSuccess ? (
            <div className="max-w-2xl mx-auto flex flex-col items-center justify-center py-20">
              ...
              <h2 className="text-2xl font-extrabold text-slate-900 mb-2">Thêm thuốc thành công!</h2>
