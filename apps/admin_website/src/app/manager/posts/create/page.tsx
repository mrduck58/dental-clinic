            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="border border-slate-200 rounded-xl overflow-hidden flex flex-col">
                ...
                <div className="bg-slate-50 border-b border-slate-200 p-2 flex flex-wrap items-center gap-1">
                  <button type="button" className="p-1.5 rounded-lg text-slate-500 hover:text-slate-800 hover:bg-slate-200/50 transition-all font-extrabold text-[13px] w-8 h-8 flex items-center justify-center">B</button>
                  <button type="button" className="p-1.5 rounded-lg text-slate-500 hover:text-slate-800 hover:bg-slate-200/50 transition-all italic text-[13px] w-8 h-8 flex items-center justify-center">I</button>
                  <button type="button" className="p-1.5 rounded-lg text-slate-500 hover:text-slate-800 hover:bg-slate-200/50 transition-all underline text-[13px] w-8 h-8 flex items-center justify-center">U</button>
                  <span className="w-[1px] h-5 bg-slate-200 mx-1"></span>
                  <button type="button" className="p-1.5 rounded-lg text-slate-500 hover:text-slate-800 hover:bg-slate-200/50 transition-all w-8 h-8 flex items-center justify-center">
                  ...
                  <button type="button" className="p-1.5 rounded-lg text-slate-500 hover:text-slate-800 hover:bg-slate-200/50 transition-all w-8 h-8 flex items-center justify-center" onClick={triggerFileInput}>
                    <svg className="w-4.5 h-4.5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/60 shadow-sm flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-3 border-t border-slate-100 pt-4">
              <button
                ...
                className="w-full bg-primary hover:bg-primary-hover text-white font-bold text-[14px] py-3 rounded-xl transition-all shadow-md shadow-primary/25 cursor-pointer"
              >
                Xuất bản
              </button>
              ...
              <button
                ...
                className="w-full bg-slate-200 hover:bg-slate-300 text-slate-700 font-bold text-[14px] py-3 rounded-xl transition-all cursor-pointer"
              >
                Lưu nháp
              </button>
            </div>
