...
const ALL_NOTIFICATIONS = [
  { id: 1, type: "appointment", title: "Bệnh nhân mới đặt lịch",     body: "Nguyễn Văn An đặt lịch khám răng vào 14:00 hôm nay · Phòng 1",                                  time: "5 phút trước",  date: "13/06/2026", read: false },
  { id: 2, type: "reminder",    title: "Nhắc nhở check-in",           body: "Còn 3 bệnh nhân chưa được check-in trong ca sáng hôm nay",                                        time: "30 phút trước", date: "13/06/2026", read: false },
  { id: 3, type: "system",      title: "Cập nhật lịch làm việc",      body: "Lịch làm việc tuần tới đã được xác nhận · Ca sáng Thứ Hai 16/06",                                 time: "2 giờ trước",   date: "13/06/2026", read: false },
  { id: 4, type: "appointment", title: "Bệnh nhân huỷ lịch",          body: "Phạm Minh Cường huỷ lịch 09:00 ngày mai · Lý do: bận công việc",                                  time: "3 giờ trước",   date: "13/06/2026", read: true  },
  { id: 5, type: "reminder",    title: "Thanh toán hóa đơn chờ xử lý", body: "Có 2 hóa đơn chưa được xác nhận thanh toán · Vui lòng kiểm tra",                                time: "4 giờ trước",   date: "13/06/2026", read: true  },
  { id: 6, type: "system",      title: "Bảo trì hệ thống",            body: "Hệ thống sẽ bảo trì từ 22:00–23:00 tối nay · Vui lòng hoàn thành công việc trước thời gian này",  time: "Hôm qua",       date: "12/06/2026", read: true  },
  { id: 7, type: "appointment", title: "Bệnh nhân đến sớm",           body: "Lê Thu Hà đã check-in lúc 07:15, sớm hơn lịch hẹn 15 phút",                                      time: "Hôm qua",       date: "12/06/2026", read: true  },
  { id: 8, type: "reminder",    title: "Nhập kho vật tư",             body: "Tồn kho bông y tế dưới mức tối thiểu · Cần nhập thêm sớm",                                        time: "2 ngày trước",  date: "11/06/2026", read: true  },
];
