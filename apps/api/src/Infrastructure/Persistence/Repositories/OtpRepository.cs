...
public class OtpRepository(AppDbContext db) : IOtpRepository
{
    ...
    public Task<OtpCode?> GetLatestValidAsync(string email, CancellationToken ct = default)
        => db.OtpCodes
            .Where(o => o.Email == email && !o.IsUsed && o.ExpiresAt > DateTime.UtcNow)
            .OrderByDescending(o => o.CreatedAt)
            .FirstOrDefaultAsync(ct);

    public async Task InvalidateAllAsync(string email, CancellationToken ct = default)
    {
