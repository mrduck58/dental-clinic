...
public class ToggleServiceStatusHandler(IServiceRepository serviceRepository)
{
    public async Task<ServiceDto> HandleAsync(Guid id, CancellationToken ct = default)
    {
