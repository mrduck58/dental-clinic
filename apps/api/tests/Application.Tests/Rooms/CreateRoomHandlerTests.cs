...
public class CreateRoomHandlerTests
{
    ...
    public async Task HandleAsync_ValidRequest_CallsAddAsyncAndReturnsDto()
    {
        ...
        var result = await handler.Handle(new CreateRoomCommand(new CreateRoomRequest("P01", "Phòng 1", "1", "Mô tả")), CancellationToken.None);
    ...
    public async Task HandleAsync_DuplicateCode_ThrowsConflictException()
    {
        ...
        Func<Task> act = () => handler.Handle(new CreateRoomCommand(new CreateRoomRequest("P01", "Phòng Mới", "1", "Mô tả")), CancellationToken.None);
    ...
    public async Task HandleAsync_DuplicateName_ThrowsConflictException()
    {
        ...
        Func<Task> act = () => handler.Handle(new CreateRoomCommand(new CreateRoomRequest("P99", "Phòng Trùng Tên", "1", "Mô tả")), CancellationToken.None);
    ...
    public async Task HandleAsync_DuplicateCodeAndName_ChecksCodeFirstAndSkipsNameCheck()
    {
        ...
        Func<Task> act = () => handler.Handle(new CreateRoomCommand(new CreateRoomRequest("P01", "Phòng Trùng", "1", "Mô tả")), CancellationToken.None);
    ...
    public async Task HandleAsync_ValidRequest_LogsActivityOnce()
    {
        ...
        await handler.Handle(new CreateRoomCommand(new CreateRoomRequest("P01", "Phòng 1", "1", "Mô tả")), CancellationToken.None);
