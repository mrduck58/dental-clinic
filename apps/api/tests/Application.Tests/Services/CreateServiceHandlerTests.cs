...
public class CreateServiceHandlerTests
{
    ...
    public async Task HandleAsync_ValidRequest_CallsAddAsyncAndReturnsDto()
    {
        ...
        var result = await handler.Handle(new CreateServiceCommand("Nhổ răng", 200000m, 30, "Mô tả", "", null, null, null), CancellationToken.None);
    ...
    public async Task HandleAsync_NewService_IsActiveByDefault()
    {
        ...
        var result = await handler.Handle(new CreateServiceCommand("Trồng răng sứ", 5000000m, 120, "Mô tả", "", null, null, null), CancellationToken.None);
    ...
    public async Task HandleAsync_WithImageUrl_ReturnsImageUrl()
    {
        ...
        var result = await handler.Handle(new CreateServiceCommand("Tẩy trắng", 800000m, 60, "Mô tả", "", "https://img.com/teeth.jpg", null, null), CancellationToken.None);
